        ...
        <div className="man">
          <div className="cardContainer relative bg-zinc-900 rounded-3xl">
            <div className="card w-1/2 h-1/2 mx-auto py-8">
              <Link to="/man">
                <img
                  src="https://i.pinimg.com/enabled/564x/6d/db/36/6ddb36d2cb4ca39e87f52b704ff35195.jpg"
                  alt=""
                />
              </Link>
            </div>
        ...
        <div className="woman">
          <div className="cardContainer relative  bg-zinc-800 rounded-3xl">
            <div className="card w-1/2 h-1/2 mx-auto py-8">
              <Link to="/woman">
                <img
                  src="https://i.pinimg.com/enabled/564x/69/9f/74/699f743a3dc0fb81c07a8636215ae437.jpg"
                  alt=""
                />
              </Link>
            </div>
