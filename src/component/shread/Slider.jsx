        ...
        <div className="child grid grid-cols-3">
          ...
          <div id="text" className="text-path">
            ...
            <p className=" text-sm font-light w-2/3">
              ...
              Repellendus saepe commodi sequi quas atque nobis tempore nihil
              nulla, deleniti vitae accusamus ducimus mollitia minima enim,
              nesciunt cumque ipsam dicta facere?
            </p>
            <button className=" mt-4 capitalize border-b-[1px] border-zinc-500">
              read more..
            </button>
          </div>
        </div>
