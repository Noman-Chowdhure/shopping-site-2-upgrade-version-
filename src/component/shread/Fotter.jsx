...
const Fotter = () => {
  return (
    <div className=" grid grid-cols-2 justify-center justify-items-center overflow-hidden ">
      ...
      <div className="detils max-sm:w-full ">
        ...
        <div className="servises grid grid-cols-2 gap-10 justify-center items-center justify-items-start ">
          <div className="service">
            ...
            <ul>
              <Link className=" font-mono uppercase border-b-[1px] border-zinc-500 py-2 block">
                instagram
              </Link>
              <Link className=" font-mono uppercase border-b-[1px] border-zinc-500 py-2 block">
                behance
